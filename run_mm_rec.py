    ...
    for epoch in range(config['train_epochs']):
        ...
        for i in range(config['num_exp']): 
            ...
            if args.accumulation == 0:
                ...
                result = rec_machine.reconstruct(input_gradient, labels_to_support, img_shape=input_shape, dryrun=iter_dryrun, txt_shape=txt_shape)
                if iter_dryrun:
                    continue
            else:
                ...
                result = rec_machine.reconstruct(input_parameters, labels_to_support, img_shape=input_shape, dryrun=args.dryrun, txt_shape=txt_shape)
