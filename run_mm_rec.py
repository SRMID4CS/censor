...
if __name__ == "__main__":
    ...
    config['cls_token_embedding'] = bert_embedding(torch.tensor([bert_tokenizer.convert_tokens_to_ids(bert_tokenizer.cls_token)]))
    config['pad_token_embedding'] = bert_embedding(torch.tensor([bert_tokenizer.convert_tokens_to_ids(bert_tokenizer.pad_token)]))
