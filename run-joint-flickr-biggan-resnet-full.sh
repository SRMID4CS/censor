#!/bin/bash
# Full ResNet mode - ResNet processes images end-to-end without transformer blocks
goal=YourGoal
...
python run_joint_mm_rec.py \
    --config configs_joint_biggan_fedcola_flickr_mm_img_txt.yml \
    --data_path $root \
    --exp_name FedCola_Joint_BigGAN_Flickr_MM_ResNet50_Full \
    --shared_param attn \
